package com.lxq.springboot_emp.config;
...
/**
 * @author liujiulong
 * @date 2019/09/26  10:24:00
 */
@Aspect
@Configuration //修饰的类为配置类
public class GlobalTransaction {
    ...
    @Bean  //创建对象  相当于<bean id = "exadvice" class = "xxxx.xxxxxx.TransactionInterceptor" >, id来自方法名
